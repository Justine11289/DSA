...
<body>
    ...
    <!--篩選-->
    <form method="GET" action="Bar_search.php">
        <div class = "wrap"> 
            <!--區域下拉式選單-->   
            <select id = "site" name = "site" style="font-size: 20px;"> 
            ...
            <!--評分下拉式選單-->
            <select id = "bar_score" name = "bar_score" style="font-size: 20px;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterBars() {
                ...
                var url = 'Bar_search.php?site=' + selectedSite + '&bar_score=' + selectedScore;
