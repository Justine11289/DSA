...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($username_input) && !empty($account_input) && !empty($password_input)) {
        ...
        if ($result->num_rows > 0) {
            ...
            // 執行註冊的SQL語句
            $sql = "INSERT INTO `bar` (`bar_name`, `bar_address`, `menu_image`, `site_id`, `map`) VALUES ('$username_input', '$account_input', '$password_input', '$siteID', '$map' )";
        ...
        <form action="#" method="post">
            <table border="0px" width="500px" height="400px" align="center" cellpadding="25px" cellspacing="0px">
                ...
                <tr>
                    ...
                    <td><input id="user_name" type="text" name="account_input" required placeholder="地址" style="font-size: 20px;"></td>
                </tr>
                <tr>
                    <td align="center"><b style="font-size: 30px;">menu網址</b></td>
                    <td><input id="password" type="text" name="password_input" required placeholder="menu網址" style="font-size: 20px;"></td>
                </tr>
                <tr>
                    <td align="center"><b style="font-size: 30px;">地區</b></td>
                    <td><input id="site" type="text" name="site" required placeholder="地區 " style="font-size: 20px;"></td>
                </tr>
